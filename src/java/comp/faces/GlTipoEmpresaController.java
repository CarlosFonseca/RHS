...
import comp.session.GlTipoEmpresaFacade;
...
@ManagedBean(name = "glTipoEmpresaController")
@SessionScoped
public class GlTipoEmpresaController {

    private GlTipoEmpresa current;
    private LazyDataModel items = null;
    @EJB
    private comp.session.GlTipoEmpresaFacade ejbFacade;
    private int selectedItemIndex;
    private int tableWidth;

    public GlTipoEmpresaController() {
    }

    public GlTipoEmpresa getSelected() {
        if (current == null) {
            current = new GlTipoEmpresa();
            selectedItemIndex = -1;
        }
        return current;
    }

    private GlTipoEmpresaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (GlTipoEmpresa) getItems().getRowData();
    ...
    @FacesConverter(forClass = GlTipoEmpresa.class)
    public static class GlTipoEmpresaControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
            GlTipoEmpresaController controller = (GlTipoEmpresaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "glTipoEmpresaController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof GlTipoEmpresa) {
                GlTipoEmpresa o = (GlTipoEmpresa) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + GlTipoEmpresaController.class.getName());
            }
        }
    }
}