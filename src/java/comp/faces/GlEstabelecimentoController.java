...
import comp.session.GlEstabelecimentoFacade;
...
@ManagedBean(name = "glEstabelecimentoController")
@SessionScoped
public class GlEstabelecimentoController {

    private GlEstabelecimento current;
    private LazyDataModel items = null;
    @EJB
    private comp.session.GlEstabelecimentoFacade ejbFacade;
    private int selectedItemIndex;
    private int tableWidth;
    private Map<String, String> autoCompleteFilter = new HashMap<String, String>();

    public GlEstabelecimentoController() {
    }
    ...
    public GlEstabelecimento getSelected() {
        if (current == null) {
            current = new GlEstabelecimento();
            selectedItemIndex = -1;
        }
        return current;
    }

    private GlEstabelecimentoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (GlEstabelecimento) getItems().getRowData();
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
     ...
     public List<GlEstabelecimento> autoComplete(String dadosFiltro){
        
        autoCompleteFilter.clear();
        autoCompleteFilter.put("globalFilter",dadosFiltro);
        autoCompleteFilter.put("id",dadosFiltro);
    ...
    @FacesConverter(forClass = GlEstabelecimento.class, value="GlEstabelecimento")
    public static class GlEstabelecimentoControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
            GlEstabelecimentoController controller = (GlEstabelecimentoController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "glEstabelecimentoController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof GlEstabelecimento) {
                GlEstabelecimento o = (GlEstabelecimento) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + GlEstabelecimentoController.class.getName());
            }
        }
    }
}