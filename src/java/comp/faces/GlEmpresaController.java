...
import comp.session.GlEmpresaFacade;
...
@ManagedBean(name = "glEmpresaController")
@SessionScoped
public class GlEmpresaController {

    private GlEmpresa current;
    private LazyDataModel items = null;
    @EJB
    private comp.session.GlEmpresaFacade ejbFacade;
    private int selectedItemIndex;
    private int tableWidth;

    public GlEmpresaController() {
    }
    ...
    public GlEmpresa getSelected() {
        if (current == null) {
            current = new GlEmpresa();
            selectedItemIndex = -1;
        }
        return current;
    }

    private GlEmpresaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (GlEmpresa) getItems().getRowData();
    ...
    @FacesConverter(forClass = GlEmpresa.class)
    public static class GlEmpresaControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
            GlEmpresaController controller = (GlEmpresaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "glEmpresaController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof GlEmpresa) {
                GlEmpresa o = (GlEmpresa) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + GlEmpresaController.class.getName());
            }
        }
    }
}