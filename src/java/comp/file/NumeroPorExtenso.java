...
//        }
        ...
        public static String[] ordensSingular= {
                "", "mil", "milh\u00E3o", "mil milh\u00F5es", "bili\u00E3o", "mil bili\u00F5es", "trili\u00E3o", "sextilh\u00E3o", "setilh\u00E3o", "octilh\u00E3o", "nonilh\u00E3o", 
        ...
        public static String[] ordensPlural = {
                "", "mil", "milh\u00F5es", "mil milh\u00F5es", "bili\u00F5es", "mil bili\u00F5es", "trili\u00F5es", "sextilh\u00F5es", "setilh\u00F5es", "octilh\u00F5es", 
        ...
        String montaGrupo(int n, int grupo) {
                ...
                if (n == 1) {
                        ...
                        if ((grupo == 1 || grupo == 3 || grupo == 5) && milSemUm) {
     ...
     * e depois reagrupa, separando por virgula exceto no ultimo separador, que pode ser
        ...
        String principal(BigDecimal n, String[] nomesMoeda) {
                ...
                String s = reagrupa(grupos) + separador.getSeparador();
                
                int x = s.indexOf("milhões", s.indexOf("milhões")+1);
                if (x>0) return s.replaceFirst("milhões ", "") + nomeMoeda;
                
               int i = s.indexOf("biliões", s.indexOf("biliões")+1);
                if (i>0) return s.replaceFirst("biliões ", "") + nomeMoeda;
        ...
        public <T extends Number> String converteMoeda(T numero) {
                return converteMoeda(numero, new String[] {"euro", "euros"}, new String[] {"centimo", "centimos"}, 100);
        }   
