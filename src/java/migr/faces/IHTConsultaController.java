...
import comp.emigrados.InfoEmpresas;
import migr.faces.util.JsfUtil;
import migr.session.InfoEmpresasFacade;
...
@ManagedBean(name = "IHTConsultaController")
@SessionScoped
public class IHTConsultaController {

    private InfoEmpresas current;
    private LazyDataModel items = null;
    @EJB
    private migr.session.InfoEmpresasFacade ejbFacade;
    private int selectedItemIndex;
    private int tableWidth;
    private String linha = "";
    private String  tipo_dscomp = "";

    public IHTConsultaController() {
    }
    ...
    public String getTipo_dscomp() {
        return tipo_dscomp;
    }

    public void setTipo_dscomp(String tipo_dscomp) {
        this.tipo_dscomp = tipo_dscomp;
    }    
        ...
        if (items == null) {
            items = new LazyDataModel() {
                ...
                public List load(int fist, int pageSize, String sortField, SortOrder sortOder, Map filters) {
                    List lazyCad = null;
//                    if (todos==false)
                        lazyCad = getFacade().findAoServico(new int[]{fist, fist + pageSize},  sortField,  sortOder, filters, linha, tipo_dscomp);
...
//                        lazyCad = getFacade().findAoServicoComIHT(new int[]{fist, fist + pageSize},  sortField,  sortOder, filters);
    ...
    public static class InfoEmpresasControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            IHTConsultaController controller = (IHTConsultaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "infoEmpresasController");
            return controller.ejbFacade.find(getKey(value));
        }

        comp.emigrados.InfoEmpresasPK getKey(String value) {
            comp.emigrados.InfoEmpresasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new comp.emigrados.InfoEmpresasPK();
        ...
        String getStringKey(comp.emigrados.InfoEmpresasPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof InfoEmpresas) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + IHTConsultaController.class.getName());
            }
        }
    }
}